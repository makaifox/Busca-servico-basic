        ...
        <div id="page-teacher-list" class="container">
            <header class="page-header">
                ...
                <div class="header-content">
                    <strong>Estes são os serviços que você esta oferecendo.</strong>
...
if ($a == "buscar") {
    ...
    $sql = mysqli_query($con,"SELECT * FROM servicos WHERE servico LIKE '%".$servico."%' AND $id = idfoto ORDER BY nome");
    ...
    if ($numRegistros != 0) {
        ...
        while ($prestador = mysqli_fetch_object($sql)) {
            ...
            if ($registroStar = mysqli_fetch_array($resultStar)){
                    ...
                    <br>
                        ...
                        <div class="row d-flex justify-content-center">
                            <form action="deleteAction.php" method="post">
                                <input type="hidden"  name="IDusuario" value="<?php  echo $prestador->idfoto; ?>" />
                                <input type="hidden"  name="servico" value="<?php  echo $prestador->servico; ?>" />
                                <input type="hidden"  name="IDservico" value="<?php  echo $prestador->id; ?>" />
                            ...
                            <form action="editarserv.php" method="post">
                                <input type="hidden"  name="IDusuario" value="<?php  echo $prestador->idfoto; ?>" />
                                <input type="hidden"  name="servico" value="<?php  echo $prestador->servico; ?>" />
                                <input type="hidden"  name="IDservico" value="<?php  echo $prestador->id; ?>" />

                                <button  type="submit" class="btn btn-sucess btn-editar" >
                                        editar 
                                    </button>
                            </form>
                        </div>
